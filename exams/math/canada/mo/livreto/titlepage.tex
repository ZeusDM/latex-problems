\begin{center}
    ...
    \textbf{Olimpíada Canadense de Matemática} \\\vspace{-.75em}
...
\vfill

	{
		...
		\noindent A versão mais atualizada desse arquivo (provavelmente) está disponível \textcolor{red}{\href{https://github.com/ZeusDM/latex-problems/blob/master/exams/math/canada/mo/livreto/livreto_canada.pdf?raw=true}{clicando aqui}}. Última atualização: \today.
