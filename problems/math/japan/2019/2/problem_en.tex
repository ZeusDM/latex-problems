Let $n\geq 3$ be an odd number. We will play a game using a $n$ by $n$ grid. The game is comprised of $n^2$ turns, in every turn, we will perform the following operation sequentially.
