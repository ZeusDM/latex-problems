...
\begin{enumerate}[label = (\alph*)]
	...
	\begin{center}
	\schemestart
	\chemfig{MnO_2}(s) + 4 \chemfig{H^+}(aq) + 2 \chemfig{e^{-}} \arrow{->} \chemfig{Mn^{2+}}(aq) + 2 \chemfig{H_2O}(l) \qquad E$^\circ = +1,23$V
	\schemestop

	\schemestart
	 \chemfig{H_2O_2}(aq) + 2 \chemfig{H^+}(aq) + 2 \chemfig{e^{-}} \arrow{->} 2 \chemfig{H_2O}(l) \qquad E$^\circ = +1,78$V
	 \schemestop
	\end{center}
